...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\theAuthor}{Alexandra Jane Stacey}
\newcommand{\authorEmail}{pyajh@leeds.ac.uk}
...
\include{Chapters/Chapter_1/Introduction} %% file path for chapter tex files 
\include{Chapters/Chapter_2/LiteratureReview}
\include{Chapters/Chapter_3/Methods}
\include{Chapters/Chapter_4/Analysis}
\include{Chapters/Chapter_5/Results}
\include{Chapters/Chapter_6/Conclusion}
